...
- [x] 05.2-01-PLAN.md — Tracer: link draft→async scrape→VIEW image/summary→BoardCard (D-08 checkpoint)
...
- [ ] 05.3-02-PLAN.md — Flip 05.1 + 05.2 VALIDATION.md to validated + nyquist_compliant (D-01..D-03) + refresh stale 05.1-UAT well-known row to live 200 (D-09) + finalize 05.3-VALIDATION task IDs
